...
class _PostGigScreenState extends State<PostGigScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      commonProvider.stateDropDwon(context, 0);
    });
  }
  ...
  void saveImage() async {
    ...
    Map requestData = {
      ...
      "location": stateDropDown,
      "subcategory": defaultSecondValue,
      "category": defaultValue,
      "video": videopicks,
      "images": finalImage,
    };
    log("images data ${json.encode(requestData)}");
              ...
              SizedBox(
                ...
                child: ListView(
                  ...
                  children: [
                        ...
                        child: DropdownButtonHideUnderline(
                          child: DropdownButton<String>(
                            ...
                            onChanged: (value) {
                              ...
                              if (defaultValue != "") {
                                Map requestData = {"parentcat": defaultValue};
                                defaultSecondValue = "";
                    ...
                    CommonButton(text: "Post Gig", callBack: saveImage),
                  ],
                ),
              ),
            ],
